...
1. Clone or download the zip.folder of the repository: [SQL Employee Tracker](https://github.com/jaldhara21/SQL-Employee-Tracker)
...
- Dynamic JavaScript 
- Inquirer.js: [Version 8.2.4](https://www.npmjs.com/package/inquirer/v/8.2.4)
- MySQL2: [Version 3.5.0](https://www.npmjs.com/package/mysql2)
- Console.table: [Version 0.10.0](https://www.npmjs.com/package/console.table)
